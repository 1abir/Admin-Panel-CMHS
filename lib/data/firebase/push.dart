...
class ApplicationState {
  ...
  Future<void> initAnxiety() async{
    ...
    var col_ref = FirebaseFirestore.instance
        .collection('/detection/anxiety/scale1');
  ...
  Future<void> initDepressionInfo() async {
    ...
    var col_ref = FirebaseFirestore.instance
        .collection('/detection/depression/info');
  ...
  Future<void> initDepression() async {
    ...
    var col_ref = FirebaseFirestore.instance
        .collection('/detection/depression/scale1');
  ...
  //
  //     q.level = i+1;
  //     // var doc_ref = col_ref.doc();
  //     // var doc_ref = await col_ref.add(q.toMap());
  //     // q.q_key = doc_ref.id;
  //     // col_ref.doc(doc_ref.path).set(q.toMap());
  //     col_ref.add(q.toMap());
  //
  //     // print("q: " + q.level.toString() + "\n ref: " +doc_ref.id+ "\npath: "+ doc_ref.path+"\n");
  //
  //   }
  //
  //   // col_ref.add(q);
